...
epochs = 2  # Number of epochs to train for. # last time I try it!!!
latent_dim = 256  # Latent dimensionality of the encoding space.
num_samples = 10000  # Number of samples to train on.

# Path to the txt dataset file on disk, inside the code directory.
data_path = './trainset/fra-eng/fra.txt' # english 2 french
data_path = './trainset/pes-eng/pes.txt' # english 2 persian
...
model.save('./model/s2s_'+ dt + '_edited2.h5')
